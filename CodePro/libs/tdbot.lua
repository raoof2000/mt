...
function tdbot.sendMention(chat_id, user_id, msg_id, text, offset, length)
assert (tdbot_function ({
_ = "sendMessage",
chat_id = chat_id,
...
function tdbot.forwardMessages(chatid, fromchatid, messageids, frombackground)
  assert (tdbot_function ({
    _ = 'forwardMessages',
    chat_id = chatid,
...
function tdbot.Restricted(chat_id, user_id, Restricted, right)
...
function tdbot.sendAudio(chat_id, audio, reply_to_message_id, title, performer, duration, caption)
  local input_message_content = {
    _ = 'inputMessageAudio',
...
function tdbot.sendVoice(chat_id, voice_file, reply_to_message_id, voi_caption, voi_duration)
  local input_message_content = {
    _ = 'inputMessageVoice',
